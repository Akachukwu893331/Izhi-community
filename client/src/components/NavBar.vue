...
<template>
  <header class="sticky inset-x-0 top-0 z-30 mx-auto w-full max-w-screen-md border border-gray-100 bg-white/80 py-2 shadow backdrop-blur-lg md:top-6 md:rounded-3xl lg:max-w-screen-lg">
    <div class="px-4">
      <div class="flex items-center justify-between">
        <div class="flex shrink-0 md:flex-1">
          <a aria-current="page" class="flex items-center space-x-1" href="/">
            ...
            <p class="text-black font-bold text-lg">Izhi-Nnnodo <span class="text-sky-500">Diaspora</span></p>
          </a>
        </div>
        ...
        <transition name="fade-slide">
          <div v-if="isMobileMenuOpen" class="absolute top-16 left-0 w-full bg-white md:hidden shadow-lg border rounded-lg p-4">
            ...
            <RouterLink to="/membership" class="flex px-4 py-2 text-sm font-medium cursor-pointer bg-sky-500 text-white rounded-xl mt-2">
        ...
        <div class="hidden md:flex md:flex-1 md:justify-center md:gap-5">
